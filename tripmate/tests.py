...
class AdminDieselTripSheetPageTests(TestCase):
    ...
    def test_admin_diesel_intelligence_page_renders(self):
        ...
        self.assertContains(response, "Most Filled Site")
        self.assertContains(response, "Highest Diesel Filled Site")
        self.assertContains(response, "Expected Fills in Upcoming 7 Days")
